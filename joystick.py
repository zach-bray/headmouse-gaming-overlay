...
from Cocoa import (
    ...
    NSTrackingArea, NSTrackingMouseEnteredAndExited,NSWindowMiniaturizeButton, NSWindowZoomButton,NSWindowStyleMaskBorderless,NSTrackingMouseMoved, NSTrackingActiveAlways,
    NSTimer
)
...
class JoystickView(NSView):
    ...
    def drawRect_(self, rect):
        ...
        if self.current_direction:
            NSColor.colorWithRed_green_blue_alpha_(0.3, 0.6, 1.0, 1).setStroke()
        else:
...
class HotkeyWindow:
    def __init__(self):
        ...
        # self.window.standardWindowButton_(NSWindowMiniaturizeButton).setHidden_(True)
        self.window.standardWindowButton_(NSWindowZoomButton).setHidden_(True)
